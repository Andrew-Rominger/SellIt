...
public class StudentListAllFragment extends Fragment {

    RecyclerView recView;
    String TAG = StudentListAllFragment.class.getSimpleName();
    View myView;


    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.student_list_all_fragment, container, false);
        return myView;
    }
